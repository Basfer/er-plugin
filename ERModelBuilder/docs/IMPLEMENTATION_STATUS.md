...
- [ ] **OCI реализация** - выполнение запросов к Oracle:
  - [ ] Инициализация OCI environment
  - [ ] Подключение к базе данных
  - [ ] Выполнение SQL запросов
  - [ ] Обработка курсоров и результатов
  - [ ] Очистка ресурсов

- [ ] **Интерактивная форма диаграммы** (`uERDiagramForm.pas`):
  - [ ] Форма с TScrollBox/TPaintBox
  - [ ] Отрисовка таблиц (заголовки, колонки, PK/FK маркеры)
  - [ ] Отрисовка связей (линии между таблицами)
  - [ ] Поддержка drag & drop
  - [ ] Zoom in/out
  - [ ] Панорамирование
  - [ ] Контекстное меню
...
- [ ] **Алгоритм авто-размещения**:
  - [ ] Force-directed layout (опционально)
  - [ ] Hierarchical layout для FK связей
...
1. **Реализовать OCI queries** в `uMetadataExtractor.ExecuteQuery`
2. **Создать форму диаграммы** `uERDiagramForm.pas` с отрисовкой
3. **Интегрировать форму** в `pdev_execute`
4. **Протестировать** на реальной БД Oracle
5. **Скомпилировать DLL** и установить в PL/SQL Developer
